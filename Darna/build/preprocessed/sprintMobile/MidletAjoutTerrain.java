 ...
 * @author Khalil
 */
public class MidletAjoutTerrain extends MIDlet implements Runnable,CommandListener {
    ...
    Alert alerta = new Alert("Error", "Sorry", null, AlertType.ERROR);
     ...
     HttpConnection hc;
    DataInputStream dis;
    String url = "http://127.0.0.1/parse1/terrain/ajoutTerrain.php";
        String urlentrepriselist = "http://127.0.0.1/parse1/terrain/getXmlPersons_Attributes.php";
