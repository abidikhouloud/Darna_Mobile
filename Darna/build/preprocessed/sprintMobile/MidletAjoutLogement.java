 ...
 * @author Khalil
 */
public class MidletAjoutLogement extends MIDlet implements Runnable,CommandListener {
    ...
    Alert alerta = new Alert("Error", "Sorry", null, AlertType.ERROR);
     ...
     HttpConnection hc;
    DataInputStream dis;
    String url = "http://127.0.0.1/parse1/logement/ajoutLogement.php";
    String urllogementlist = "http://127.0.0.1/parse1/logement/getXmlPersons_Attributes.php";
