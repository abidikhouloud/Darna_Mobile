 ...
 * @author Khalil
 */
public class MidletChercherTerrain extends MIDlet implements CommandListener, Runnable {
...
Command vib,exit;
    ...
    public void afficherLogement(){
        try {//les threads
            ...
            HttpConnection hc = (HttpConnection) Connector.open("http://127.0.0.1/parse1/terrain/rechercheTerrain.php?region="+table[chG.getSelectedIndex()]);
