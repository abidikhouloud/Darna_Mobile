...
public class MidletListTerrain extends MIDlet implements CommandListener, Runnable {
...
Display disp = Display.getDisplay(this);
    ...
    public void afficherTerrain()
    {
        ...
        try {//les threads
            ...
            HttpConnection hc = (HttpConnection) Connector.open("http://127.0.0.1/parse1/terrain/getXmlPersons_Attributes.php");
    ...
    {
        try {
               HttpConnection hc = (HttpConnection) Connector.open("http://127.0.0.1/parse1/terrain/supprimerTerrain.php"+"?id="+id);
    ...
    public void modifierTerrain() throws IOException
    {
        ...
        String url="http://127.0.0.1/parse1/terrain/ModifierTerrain.php" ;
        if (terrains.length > 0) {
            HttpConnection hc2 = (HttpConnection) Connector.open("http://127.0.0.1/parse1/terrain/ModifierTerrain.php" +"?id="+id+ "&description=" + tfDescription.getString().trim() + "&region=" + table[chG.getSelectedIndex()].trim() + "&prix=" + tfPrix.getString().trim() + "&surface=" + tfSurface.getString().trim() +  "&vocation=" + tfVocation.getString().trim() + "&engagement="+ table1[chEngagement.getSelectedIndex()].trim());
