 ...
 * @author Khalil
 */
public class AjoutEntreprise  implements Runnable,CommandListener {
    ...
    Alert alerta = new Alert("Error", "Sorry", null, AlertType.ERROR);
     ...
     HttpConnection hc;
    DataInputStream dis;
    String url = "http://localhost/parse1/entreprise/ajoutEntreprise.php";
        String urlentrepriselist = "http://localhost/parse1/entreprise/getXmlPersons_Attributes.php";
    StringBuffer sb1 = new StringBuffer();
    int ch;

    public AjoutEntreprise(Display disp) {
        this.disp = disp;
         this.startApp();
    }
