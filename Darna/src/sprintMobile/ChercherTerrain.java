 ...
 * @author Khalil
 */
public class ChercherTerrain implements CommandListener, Runnable{
...
Command vib,exit;
    ...
    public ChercherTerrain(Display disp) {
        this.disp = disp;
         this.startApp();
    }
    ...
    public void afficherLogement(){
        try {//les threads
            ...
            HttpConnection hc = (HttpConnection) Connector.open("http://localhost/parse1/terrain/rechercheTerrain.php?region="+table[chG.getSelectedIndex()]);
