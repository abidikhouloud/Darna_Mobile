 ...
 * @author Khalil
 */
public class MidletListEntreprise extends MIDlet implements CommandListener,Runnable {
  ...
  form.addCommand(cmdParse2);
    ...
    public void afficherEntreprise()
    {
         ...
         try {//les threads
            ...
            HttpConnection hc = (HttpConnection) Connector.open("http://127.0.0.1/parse1/entreprise/getXmlPersons_Attributes.php");
