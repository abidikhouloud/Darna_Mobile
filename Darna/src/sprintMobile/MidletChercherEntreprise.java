 ...
 * @author Khalil
 */
public class MidletChercherEntreprise extends MIDlet implements CommandListener, Runnable {
...
Command vib,exit;
    ...
    public MidletChercherEntreprise() {
    }
    ...
    public void afficherLogement(){
        try {//les threads
            ...
            HttpConnection hc = (HttpConnection) Connector.open("http://127.0.0.1/parse1/entreprise/recherentreprise.php?region="+table[chG.getSelectedIndex()]);
