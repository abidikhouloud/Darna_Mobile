...
public class ChercherLogement implements CommandListener, Runnable{
...
Command vib,exit;
    ...
    public ChercherLogement(Display disp) {
        this.disp = disp;
         this.startApp();
    }
    ...
    public void afficherLogement(){
        try {//les threads
            ...
            HttpConnection hc = (HttpConnection) Connector.open("http://localhost/parse1/logement/recherchelogement.php?region="+table[chG.getSelectedIndex()]);
