 ...
 * @author Khalil
 */
public class DynamicMap implements CommandListener{


    MIDlet m;
    Display disp;
    
    TextField TFDepart=new TextField("Lieu de cherché",null,40,TextField.ANY);
    ...
    String urlLat1 = "http://localhost/parse1/map/mapLat1.php";
    String reponse1;
    
    String urlLong1 = "http://localhost/parse1/map/mapLong1.php";
    String reponse2;
    int ch;
    int ch2;
    int ch3;
    ...
    public DynamicMap(Display disp) {
        this.disp = disp;
        this.m=m;
         this.startApp();
    }
    ...
    public void commandAction(Command cmnd, Displayable dsplbl) {
        ...
        if (cmnd == cmdAffiche) {
            ...
            disp.setCurrent(new GoogleMapsZoomCanvas(m, dsplbl, Double.parseDouble(reponse1), Double.parseDouble(reponse2), Double.parseDouble(reponse3), Double.parseDouble(reponse4),disp));
